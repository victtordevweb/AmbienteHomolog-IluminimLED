      ...
      let TextosCategoriaRodape = {
         ...
         gerarObjeto(){
            ...
            let objeto = {
               ...
               ['1608472']: {
                  html: 'Se você está aqui, provavelmente está atrás de uma <strong>iluminação para escritório</strong> de alta qualidade, não é?! Então fique tranquilo, pois você está no lugar certo!<br/><br/>A Iluminim oferece a maior linha em <strong>luz de LED para escritório</strong>, seja para a escrivaninha com uma <a href="/luminaria-de-mesa">luminaria de LED para mesa</a>, quanto para o teto com <a href="/spot-led-trilho-eletrificado?sort=mais_vendidos">spots e trilho eletrificado</a>. Temos tudo em iluminação de alta performance e baixo consumo de energia para o seu ambiente.<br/><br/>De iluminação para escritório pequeno ao grande, garantimos sempre o melhor preço e as melhores condições de pagamento para você. Além disso, temos o prazer de lhe entregar a maior garantia do segmento no Brasil.<br/><br/>Somos a casa da <strong>iluminação de escritório</strong>, compre em até 12x sem juros no cartão, ou receba 5% de desconto para pagamentos no boleto à vista. Entrega rápida e eficaz. Confie em quem entende de LED. Confie na líder!'
               },
