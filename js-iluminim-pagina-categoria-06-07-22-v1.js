var PaginaCategoria = {
	...
	paginasPersonalizadas(){
	   ...
	   let PaginasPersonalizadas = [
				...
				return `
				   <div id="allDepartment">
						 ...
						 <div class="texto-dpt span12">
							...
							a maior garantia do mercado e as melhores condições de pagamento. Parcelamos em até 12x sem juros, oferecemos 5% de desconto no 
						 ...
						 <div class="block-categories span12">
							<div class="block-categories-into one span12">
							   ...
							   <div class="span4">
									 <h4><a href="/spots">Spots LED</a></h4>
									 ...
									 <ul>
										...
										<li><a href="/spot-led-trilho-eletrificado"><i class="icon-chevron-right"></i> Spot LED para Trilho Eletrificado</a></li>
							...
							<div class="block-categories-into two span12">
							   <div class="span4">
									 <h4><a href="/fita-de-led">Fitas LED</a></h4>
							   ...
							   <div class="span4">
									 <h4><a href="/lampada-led">Lâmpadas LED</a></h4>
							   ...
							   <div class="span4">
									 <h4><a href="/acessorios-para-leds">Acessórios LED</a></h4>
						 ...
						 <div class="block-call-action span12">
							...
							<div class="block-environment span6">
							   ...
							   <div class="box-call-environment span6">
									 ...
									 <a href="/compre-por-ambiente">Confira!</a>
							   </div>
							</div>
						 </div>
						 ...
						 <div class="gird-listagem-customizada-conteudo grid-listagem-1">
							<div class="grid-listagem-item">
							   <a href="/plafon-led-sobrepor?sort=mais_vendidos" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Promoções plafons')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-promocoes-luminarias-02-12-21.png" alt="Promoções plafons" title="Promoções plafons">
							   </a>
							</div>
						 ...
						 <div class="gird-listagem-customizada-conteudo grid-listagem-2">
							<div class="grid-listagem-item">
							   <a href="/arandela-led?sort=mais_vendidos" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Arandela LED')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-arandelas-led-02-12-21.png" alt="Arandela LED" title="Arandela LED">
							   </a>
							</div>
 
							<div class="grid-listagem-item">
							   <a href="/plafon-led?sort=mais_vendidos" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Plafon LED')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-plafon-led-02-12-21.png" alt="Plafon LED" title="Plafon LED">
							   </a>
							</div>
 
							<div class="grid-listagem-item">
							   <a href="/lustre" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Lustre LED')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner_lustre-pagina_luminarias-03-12-21.png" alt="Lustre LED" title="Lustre LED">
							   </a>
							</div>
						 </div>
			 ...
			 gerarHTML(){
				...
				return `
				   <div class="gird-listagem-customizada">
						 ...
						 <div class="gird-listagem-customizada-conteudo grid-listagem-1">
							<div class="grid-listagem-item">
							   <iframe allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="235" src="https://www.youtube.com/embed/dyKA-VI0kn8" width="427"></iframe>
							</div>
 
							<div class="grid-listagem-item">
							   <iframe allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="235" src="https://www.youtube.com/embed/l8p5QVHf4Es" width="427"></iframe>
							</div>
						 </div>
 
						 <div class="gird-listagem-customizada-conteudo grid-listagem-2">
							<div class="grid-listagem-item">
							   <a href="/luminarias-led?sort=mais_vendidos" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Plafon LED')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-pagina-categoria-luminaria-plafon-led-03-12-21.png" alt="Arandela LED" title="Arandela LED">
							   </a>
							</div>
 
							<div class="grid-listagem-item">
							   <a href="/lustre" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Lustre LED')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-pagina-categoria-luminaria-lustre-led-03-12-21.png" alt="Plafon LED" title="Plafon LED">
							   </a>
							</div>
 
							<div class="grid-listagem-item">
							   <a href="/pendente?sort=mais_vendidos" onclick="ga('send', 'event', 'Grid banners Categoria', 'click', 'Pendente LED')">
									 <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-pagina-categoria-luminaria-pendente-led-03-12-21.png" alt="Lustre LED" title="Lustre LED">
							   </a>
							</div>
						 </div>
		  ...
		  {
			 paginasURL: ['/ofertadasemana', '/led-natal'],
			 ...
			 listagensPersonalizadas: {
				...
				gerarObjeto(){
				   ...
				   let objeto = {
						 ...
						 ['/ofertadasemana']: [
							...
							{
							   url: '/kits-led',
							   imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/KITs-banner-ods-23-06-2022.png',
							   nome: 'Kits LED'
							},
							{
							...
							},
							{
							   ...
							   imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Lustres-banner-ods-23-06-2022.png',
							   nome: 'Lustres LED'                    
							},
							{
							   url: '/acessorios-para-leds?sort=mais_vendidos',
							   imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Acessorios_LED-banner-ods-23-06-2022.png',
							   nome: 'Acessórios LED'
							},
							{
						 ...
						 ['/led-natal']: [
							{
							   ...
							   url_vermais: '/refletor-led-para-natal?sort=mais_vendidos',
							...
							},
							{
							   ...
							   url_vermais: '/plafon-led?sort=mais_vendidos',
							...
							},
							{
							   ...
							   url_vermais: '/fita-led-para-natal?sort=mais_vendidos',
							...
							},
							{
							   ...
							   url_vermais: '/lampada-led-para-natal?sort=mais_vendidos',
							...
							},
							{
							   ...
							   url_vermais: '/pendente?sort=mais_vendidos',
							...
							},
							{
							   ...
							   url_vermais: '/acessorios-para-leds',
				...
				gerarHTML(){
				   ...
				   let HTMLCategorias = objeto.map((item, index) => {
						 ...
						 let { url, url_vermais, imagem, nome } = item;
									 ...
									 <div class="banner--progresso">
										...
										${ILUMINIM_UTILS.screen.isMobile() ? `
										   <div class="banner-titulo">
											  ...
											  <span>${nome}</span>
											  <a href="${url_vermais ? url_vermais : url}">Ver mais</a>
										   </div>
										` : ''}
				...
				carregarProdutos(){ //CARREGANDO OS PRODUTOS NAS SUAS CATEGORIAS RESPECTIVAS.
				   ...
				   $('#OfertaSemanaCustomizada .conteudo-ofertasemana--bloco-categoria').each(function(){
						 ...
						 $(this).find('.bloco-categoria--produtos .produtos--produtos-carrousel').load(`${urlLoad} div#listagemProdutos .listagem-item:not(.indisponivel)`, ()=>{
							...
							if($(this).find('.listagem-item').length > 0){
							   ...
							   $(this).find('.listagem-item').each(function(){
									 let id = $(this).attr('class').split('prod-id-')[1].split(' ')[0];
 
									 $(this).addClass('produto-adicionar-direto-carrinho').append(`
										 <div class="adicionar-direto-carrinho">
											 <a href="/carrinho/produto/${id}/adicionar">Adicionar ao carrinho</a>
										 </div>
									 `);
							   });
				...
				cronometros(){
				   ...
				   $(`
					  .banner.cheio .slides img[alt="Categoria -> /ofertadasemana - Chamada Cronometro"],
					  .banner.cheio .slides img[alt="Categoria -> /ofertadasemana - Chamada Cronometro - @mobile"],
					  .banner.cheio .slides img[alt="Categoria -> /led-natal - Chamada Cronometro"],
					  .banner.cheio .slides img[alt="Categoria -> /led-natal - Chamada Cronometro - @mobile"]
				   `).after(`
				...
				barraProgressoFullBanner(){
				   ...
				   $(`
					  ...
					  .banner.cheio .slides img[alt="Categoria -> /led-natal - Chamada Cronometro - @mobile"]
				   `).after(`
					  ${window.location.pathname == '/led-natal' ? `
				...
				adicionarClassesCustomizadasBody(){
				   ...
				   if(window.location.pathname == '/led-natal'){
 
					  $('body').addClass('pagina-led-natal');
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-lancamentos-refletores-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/lancamento-refletor-led?sort=ultimos_produtos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lancamentos-fios-e-cabos">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/cabo-de-energia?sort=ultimos_produtos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lancamentos-plafons-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/lancamento-plafon-led-?sort=ultimos_produtos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lancamentos-lustres-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/lustre-led?sort=ultimos_produtos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lancamentos-abajur-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/luminaria-abajur?sort=ultimos_produtos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lancamentos-pendentes-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/lancamento-pendente?sort=ultimos_produtos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-frete-gratis-refletores-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/frete-gratis-refletor-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-frete-gratis-luminarias-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/frete-gratis-luminaria-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-frete-gratis-spots-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/frete-gratis-spot-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-frete-gratis-pendentes-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/pendente?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-frete-gratis-fitas-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/frete-gratis-fita-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-frete-gratis-lampadas-led">
							   <div class="iluminim-loading" style="display: none;"></div>
 
							   <a class="listagem-customizada-ver-todos" href="/frete-gratis-lampada-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 ...
 
		  {
			 ...
			 paginasURL: ['/fita-de-led', '/fita-led-friday'],
		  ...
		  {
			 paginasURL: ['/lampada-led', '/lampada-led-friday'],
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-lampada-led-kits-lampadas">
							   <div class="iluminim-loading" style="display: none;"></div>
							...
							<div class="banner-listagem-customizada">
							   <a href="/pagina/pack-bulbo-avant.html">
								  <img src="https://cdn.awsli.com.br/257/257163/arquivos/BANNER_PACK_BULBO-24-02-2022.png">
							   </a>
							</div>
							...
							<div class="listagem-customizada listagem-lampada-led-decorativas">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/lampadas-decorativas?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
							...
							<!--<div class="gird-listagem-customizada">
							   <div class="gird-listagem-customizada-conteudo grid-listagem-1 grid-listagem-duplo-video">
								  <div class="grid-listagem-item">
									 <iframe allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="235" src="https://www.youtube.com/embed/p7BXn7D2VRI" width="427"></iframe>
								  </div>
 
								  <div class="grid-listagem-item">
									 <iframe allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="235" src="https://www.youtube.com/embed/dWZgZWDSVlc" width="427"></iframe>
								  </div>
							   </div>
							</div>-->
							...
							<!--<div class="banner-listagem-customizada">
							   <a href="/lancamento-lampada-led?sort=ultimos_produtos">
								  <img src="https://cdn.awsli.com.br/257/257163/arquivos/banner-lampada-vintage-63off-29-12-21.png">
							   </a>
							</div>-->
		  ...
		  {
			 paginasURL: ['/compre-por-ambiente'],
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="banner-listagem-customizada">
							   <a href="/led-para-area-interna?sort=mais_vendidos">
								  <img src="https://cdn.awsli.com.br/257/257163/arquivos/LED_para_area_interna_13-01-22.png">
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-cpm-led-para-area-interna">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/led-para-area-interna?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-cpm-led-para-sala-de-estar">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/led-para-sala-de-estar?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="banner-listagem-customizada">
							   <a href="/led-para-area-externa?sort=mais_vendidos">
								  <img src="https://cdn.awsli.com.br/257/257163/arquivos/LED_Para_Area_Externa_13-01-22.png">
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-cpm-led-para-area-externa">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/led-para-area-externa?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
							...
							<div class="gird-listagem-customizada">
							   <div class="gird-listagem-customizada-conteudo grid-listagem-1 grid-listagem-duplo-video">
								  <div class="grid-listagem-item">
									 <iframe allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="235" src="https://www.youtube.com/embed/X4hjYpzuml8" width="427"></iframe>
								  </div>
 
								  <div class="grid-listagem-item">
									 <iframe allow="autoplay; encrypted-media" allowfullscreen="" frameborder="0" height="235" src="https://www.youtube.com/embed/sHFo3V0UZIo" width="427"></iframe>
								  </div>
							   </div>
							</div>
 
							<div class="listagem-customizada listagem-cpm-led-para-cozinha">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/led-para-cozinha?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-cpm-led-para-escritorio">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/led-para-escritorio?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="banner-listagem-customizada">
							   <a href="/led-para-jardim?sort=mais_vendidos">
								  <img src="https://cdn.awsli.com.br/257/257163/arquivos/LED_Para_Jardim_13-01-22.png">
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-cpm-led-para-jardim">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/led-para-jardim?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-cpm-lancamentos">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/lancamentos-led">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
		  ...
		  {
			 paginasURL: ['/led-para-sala-de-jantar'],
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-lpsdj-luminarias-led">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/luminarias-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lpsdj-lampadas-led">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/lampada-led">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lpsdj-lustres-led">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/lustre">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-lpsdj-pendentes-led">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/pendente?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
 ...
 
		  {
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-kit-spot-led-trilho">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/kit-trilho-eletrificado-com-spot-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
							...
							<div class="listagem-customizada listagem-spot-led-trilho">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/spot-led-trilho-eletrificado">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
			 ...
			 renderizar(){
				...
				/*$('.pagina-personalizada-listagens-customizadas .ordenar-listagem.topo').after(`
				   <div class="listagem-customizada listagem-spot-baixaram-de-preco">
					  <div class="iluminim-loading" style="display: none;"></div>
				   </div>
				`);*/
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-acessorios-fios-cabos">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/cabo-de-energia?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
							...
							<div class="listagem-customizada listagem-acessorios-sensor-de-presenca-led">
							   <div class="iluminim-loading" style="display: none;"></div>
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-kits-especiais-kit-spot-led-trilho">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/kit-trilho-eletrificado-com-spot-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
		  ...
		  {
			 paginasURL: ['/spot-led-trilho-eletrificado'],
				...
				return `
				   <div class="listagens-customizadas">
						 <div class="listagens-customizadas-listas">
							...
							<div class="listagem-customizada listagem-spots-led-trilho-produtos-spot-trilho">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/buscar?q=spot+led+trilho+eletrificado">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							</div>
 
							<div class="listagem-customizada listagem-spots-led-trilho-produtos-trilho">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/spot-led-trilho-eletrificado">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							...
							<div class="listagem-customizada listagem-spots-led-trilho-produtos-spot-sobrepor">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/spot-led-sobrepor?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
							...
							<div class="listagem-customizada listagem-spots-led-trilho-produtos-kit-spot-trilho">
							   <div class="iluminim-loading" style="display: none;"></div>
							   <a class="listagem-customizada-ver-todos" href="/kit-trilho-eletrificado-com-spot-led?sort=mais_vendidos">
									 <span class="ver-todos">Ver Todos <i class="icon-list-ul"></i></span>
							   </a>
	   ...
	   const DuploVideo = {
		  ...
		  gerarObjeto(){
			 ...
			 let config = {
				...
				['/pendente']: {
				   seletor: 'div#listagemProdutos .listagem-linha:nth-child(2)',
				   videos: ['l8p5QVHf4Es', 'GYOAFC7uH7A']
				},
	...
	bannerPaginaLampadaBulbo(){
 
	   if(!ILUMINIM_UTILS.screen.isDesktop()){
		  return;
	   }
 
	   if($('body.pagina-categoria.categoria-1115341').length > 0){
 
		  $('div#listagemProdutos li.listagem-linha:nth-child(2)').after(`
			 <div class="banner-listagem-customizada">
				<a href="/pagina/pack-bulbo-avant.html">
				   <img src="https://cdn.awsli.com.br/257/257163/arquivos/BANNER_PACK_BULBO-24-02-2022.png">
				</a>
	...
	bannerPaginaLEDExterna(){
 
	   if(!ILUMINIM_UTILS.screen.isDesktop()){
		  return;
	   }
 
	   if($('body.pagina-categoria.categoria-3366286').length > 0){
 
		  $('div#listagemProdutos li.listagem-linha:nth-child(7)').after(`
			 <div class="banner-listagem-customizada">
				<a href="/refletores-de-led?sort=mais_vendidos">
				   <img src="https://cdn.awsli.com.br/257/257163/arquivos/WIREFRAME_MAIS_VENDIDOS_REFLETORES-09-03-2022.png">
				</a>
			 </div>
		  `);
	...
	bannerPaginaLEDParaQuarto(){
 
	   if(!ILUMINIM_UTILS.screen.isDesktop()){
		  return;
	   }
 
	   if($('body.pagina-categoria.categoria-1608470').length > 0){
 
		  $('div#listagemProdutos li.listagem-linha:nth-child(7)').after(`
			 <div class="banner-listagem-customizada">
				<a href="/luminaria-plafon-62x62-48w-led-embutir-branco-neutro-borda-branca">
				   <img src="https://cdn.awsli.com.br/257/257163/arquivos/PS-Q48WBN-62X62-10-03-2022.png">
				</a>
			 </div>
		  `);
	...
	palavrasMaisBuscadas(){
	   ...
	   let PalavrasMaisBuscadas = {
		  ...
		  gerarObjeto(){
			 ...
			 let config = [
				 
				 {
					 paginas: [
						 '/plafon-led-embutir',
						 '/plafon-led-embutir-quadrado',
						 '/plafon-led-embutir-redondo',
						 '/plafon-led-embutir-retangular',
						 '/plafon-led-sobrepor',
						 '/plafon-led-sobrepor-quadrado',
						 '/plafon-led-sobrepor-retangular',
						 '/plafon-led-colorido',
						 '/plafon-led-borda-infinita',
						 '/luminaria-plafon-led-recuado',
						 '/kit-plafon',
					 ],
					 palavras: [
						 { palavra: 'lampada de emergencia', link: 'https://www.iluminim.com.br/luminaria-emergencia-led?sort=mais_vendidos' },
						 { palavra: 'luminárias de emergência', link: 'https://www.iluminim.com.br/luminaria-emergencia-led?sort=mais_vendidos' },
						 { palavra: 'luminária pendente para sala', link: 'https://www.iluminim.com.br/pendente?sort=mais_vendidos' },
						 { palavra: 'lampada solar para jardim', link: 'https://www.iluminim.com.br/espeto-led?sort=mais_vendidos' },
						 { palavra: 'luminaria de chão para sala', link: 'https://www.iluminim.com.br/luminaria-de-piso-led-articulada-e27' },
						 { palavra: 'luminaria pendente para cozinha', link: 'https://www.iluminim.com.br/pendente?sort=mais_vendidos' },
						 { palavra: 'luminaria quarto infantil', link: 'https://www.iluminim.com.br/buscar?q=abajur' },
						 { palavra: 'lampada quadrada', link: 'https://www.iluminim.com.br/plafon-led?sort=mais_vendidos' },
						 { palavra: 'led de embutir', link: 'https://www.iluminim.com.br/plafon-led-embutir?sort=mais_vendidos' },
						 { palavra: 'refletor solar para jardim', link: 'https://www.iluminim.com.br/refletor-led-solar?sort=mais_vendidos' },
						 { palavra: 'lustre de led para sala', link: 'https://www.iluminim.com.br/lustre' },
						 { palavra: 'placa de led embutir', link: 'https://www.iluminim.com.br/plafon-led-embutir?sort=mais_vendidos' },
					 ]
				 },
 
				 {
					 paginas: [
						 '/plafon-led-sobrepor-redondo',
					 ],
					 palavras: [
						 { palavra: 'plafon sobrepor redondo grande', link: '/luminaria-plafon-led-40cm-48w-sobrepor-redondo-chanfro-3-cores-dourado' },
						 { palavra: 'plafon sobrepor redondo 25w', link: '/luminaria-plafon-25w-led-sobrepor-branco-frio-redondo' },
						 { palavra: 'plafon sobrepor redondo 30 cm', link: '/luminaria-plafon-25w-led-sobrepor-branco-frio-redondo' },
						 { palavra: 'plafon sobrepor redondo 18w', link: '/luminaria-plafon-18w-led-sobrepor-branco-frio-redondo' },
						 { palavra: 'plafon sobrepor redondo branco', link: '/luminaria-plafon-18w-led-sobrepor-branco-frio-redondo' },
						 { palavra: 'plafon sobrepor redondo preto', link: '/luminaria-plafon-25w-led-sobrepor-redondo-branco-frio-neutro' },
						 { palavra: 'painel led sobrepor redondo', link: '/luminaria-plafon-18w-led-sobrepor-branco-frio-redondo' },
						 { palavra: 'plafon sobrepor', link: '/plafon-led-sobrepor?sort=mais_vendidos' },
					 ]
				 },
 
				 {
					 paginas: ['/spot-led-trilho-eletrificado'],
					 palavras: [
					 { palavra: 'spot trilho', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'trilho com spots', link: '/kit-trilho-eletrificado-1-5m-3-spot-led-10w-branco-quente-preto' },
					 { palavra: 'spot de trilho', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'spot para trilho', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'trilho de spot', link: '/buscar?q=trilho+de+spot' },
					 { palavra: 'luminaria spot trilho', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'spot para trilho eletrificado', link: '/spot-led-trilho-eletrificado' },
					 ...
					 { palavra: 'trilho spot sala', link: '/spot-led-trilho-eletrificado' },
					 ...
					 { palavra: 'trilho spot cozinha', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'trilhos com spots direcionáveis', link: '/kit-trilho-eletrificado-1-5m-3-spot-led-10w-branco-quente-preto' },
					 { palavra: 'lustre spot trilho', link: '/spot-led-trilho-eletrificado' },
					 ...
					 { palavra: 'lampada led spot trilho', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'spot dicroica trilho', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'spot trilho preço', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'spot trilho teto', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'trilho spot banheiro', link: '/spot-led-trilho-eletrificado' },
					 ...
					 { palavra: 'lampada spot', link: '/par-led?sort=mais_vendidos' },
					 { palavra: 'spot led embutir quadrado', link: '/spot-led-quadrado?sort=mais_vendidos' },
					 { palavra: 'spot quadrado', link: '/spot-led-quadrado?sort=mais_vendidos' },
					 { palavra: 'luminaria spot led', link: '/spot-led-smd-7w-quadrado-branco-frio' },
					 { palavra: 'spot de teto', link: '/spot-led-sobrepor?sort=mais_vendidos' },
					 { palavra: 'spot led embutir redondo', link: '/spot-led-redondo?sort=mais_vendidos' },
					 { palavra: 'spot para lampada', link: '/spot-led-recuado?sort=mais_vendidos' },
					 { palavra: 'luminária de teto spot', link: '/spot-led-sobrepor?sort=mais_vendidos' },
					 ],
				 },
	 
				 {
					 paginas: ['/spot-led-embutir'],
					 palavras: [
	 ...
	 
				 {
					 ...
					 { palavra: 'lampada tubular', link: '/lampada-led-tubular-2-40m?sort=mais_vendidos' },
					 { palavra: 'lampada solar para jardim', link: '/luminaria-solar-led-sensor-de-movimento-1w-prateada' },
					 { palavra: 'lâmpada recarregável', link: '/luminaria-de-emergencia-30-leds-slim' },
					 { palavra: 'lampada vermelha', link: '/lampada-led-bulbo-7w-residencial-vermerlho-bivolt-e27-inmetro' },
					 { palavra: 'lampada tubular led 18w', link: '/lampada-led-tubular-t8-18w-60cm-roxo-inmetro' },
					 { palavra: 'lâmpada inteligente alexa', link: '/lampada-led-bulbo-10w-rgb-bivolt-smart-compativel-com-alexa-elgin' },
					 ],
				 },
	 
				 {
					 paginas: ['/led-automotivo'],
					 palavras: [
					 ...
					 { palavra: 'lampada g9 led', link: '/lampada-led-halopin-g9-5w-branco-quente-220V' },
					 { palavra: 'lampada solar para jardim', link: '/luminaria-solar-led-sensor-de-movimento-1w-prateada' },
					 { palavra: 'lâmpada recarregável', link: '/luminaria-de-emergencia-30-leds-slim' },
					 { palavra: 'lampada vermelha', link: '/lampada-led-bulbo-7w-residencial-vermerlho-bivolt-e27-inmetro' },
					 { palavra: 'lampada tubular led 18w', link: '/lampada-led-tubular-t8-18w-60cm-roxo-inmetro' },
	 ...
	 
				 {
					 ...
					 { palavra: 'mangueira de led',	link: '/mangueiras-led?sort=mais_vendidos' },
					 { palavra: 'fio de leds',	link: '/kit-fita-led?sort=mais_vendidos' },
					 { palavra: 'led rgb 5050',	link: '/fita-led-rgb-colorida-5050-5-metros-com-fonte' },
					 { palavra: 'fita neon',	link: '/fita-led-rgb-colorida-5050-5-metros-com-fonte' },
					 { palavra: 'fita de led para quarto',	link: '/fita-led-rgb?sort=mais_vendidos' },
					 { palavra: 'fonte para fita de led',	link: '/fonte-12v-3a-para-led' },
					 { palavra: 'fita led 10m',	link: '/fita-led-5-metros?sort=mais_vendidos' },
					 { palavra: 'fita de led neon',	link: '/mangueiras-led?sort=mais_vendidos' },
					 { palavra: 'fita de led amarela',	link: '/fita-led-branco-quente-5050-5-metros-com-fonte' },
					 { palavra: 'fonte para led',	link: '/fonte-12v-3a-para-led' },
					 { palavra: 'fita led alexa',	link: '/controlador-wireless-inteligente-fita-led-rgb-3528-e-5050' },
					 { palavra: 'mangueira de led colorida',	link: '/mangueira-led-rgb-100-metros-ultra-intensidade-a-prova-dagua' },
					 ],
				 },
	 
				 {
					 paginas: ['/fita-led-branco-quente'],
					 palavras: [
				 ...
				 {
					 paginas: ["/refletores-de-led", "/refletor-led-friday"],
					 palavras: [
					 ...
					 { palavra: 'holofote solar', link: '/refletor-led-solar?sort=mais_vendidos' },
					 { palavra: 'refletor de luz', link: '/refletores-de-led?sort=mais_vendidos' },
					 { palavra: 'refletor solar 200w', link: '/refletor-led-solar-200w-80-leds-auto-recarregavel' },
					 { palavra: 'refletor led 150w', link: '/refletor-microled-ultra-150w-branco-frio-black-type' },
					 { palavra: 'mini refletor led', link: '/mini-refletor-led?sort=mais_vendidos' },
					 { palavra: 'refletor led verde', link: '/refletor-micro-led-ultra-thin-verde?sort=mais_vendidos' },
					 { palavra: 'refletor pequeno', link: '/mini-refletor-led?sort=mais_vendidos' },
					 { palavra: 'refletor led colorido', link: '/refletor-micro-led-ultra-thin-rgb?sort=mais_vendidos' },
					 ],
				 },
 
				 {
					 paginas: ["/luminarias-led", "/luminarias-led-friday"],
					 palavras: [
				 ...
				 {
					 paginas: ["/plafon-led", "/plafon-led-friday"],
					 palavras: [
					 ...
					 { palavra: 'Luminária Plafon 25w LED Sobrepor', link: '/luminaria-plafon-25w-led-sobrepor-branco-frio-quadrado' },
					 ...
					 { palavra: 'Luminária Plafon 25w LED Embutir', link: '/luminaria-plafon-25w-led-embutir-branco-frio-quadrado' },
					 { palavra: 'Luminária Plafon 18w LED Embutir', link: '/luminaria-plafon-18w-led-embutir-branco-frio-quadrado' },
					 ...
					 { palavra: 'Luminária Plafon 18w LED Sobrepor', link: '/luminaria-plafon-18w-led-sobrepor-branco-frio-quadrado' },
					 ...
					 { palavra: 'Luminária Plafon 25w LED Embutir', link: '/luminaria-plafon-25w-led-embutir-branco-neutro-quadrado' },
					 { palavra: 'Plafon sobrepor 25w', link: '/luminaria-plafon-25w-led-sobrepor-branco-frio-quadrado' },
					 { palavra: 'Luminária Plafon 12w LED Sobrepor', link: '/luminaria-plafon-25w-led-sobrepor-branco-frio-quadrado' },
					 { palavra: 'plafon 20x20', link: '/luminaria-plafon-12w-led-sobrepor-branco-neutro-quadrado' },
					 { palavra: 'Kit 5 Luminária Plafon LED 25w', link: '/kit-5-luminaria-plafon-25w-led-sobrepor-quadrado-branco-frio' },
					 ...
					 { palavra: 'plafon led', link: '/plafon-led?sort=mais_vendidos' },
					 { palavra: 'plafon de embutir', link: '/plafon-led-embutir?sort=mais_vendidos' },
					 { palavra: 'lampada de led quadrada', link: '/plafon-led?sort=mais_vendidos' },
					 { palavra: 'painel led sobrepor', link: '/plafon-led-sobrepor?sort=mais_vendidos' },
					 { palavra: 'luminária de led sobrepor', link: '/plafon-led-sobrepor?sort=mais_vendidos' },
					 { palavra: 'plafon de teto', link: '/plafon-led?sort=mais_vendidos' },
					 { palavra: 'plafon luz indireta', link: '/luminaria-plafon-led-recuado' },
					 { palavra: 'plafon sobrepor quadrado', link: '/plafon-led-sobrepor-quadrado?sort=mais_vendidos' },
					 { palavra: 'luminaria de led de embutir', link: '/plafon-led-embutir?sort=mais_vendidos' },
					 { palavra: 'plafon sobrepor redondo', link: '/plafon-led-sobrepor-redondo?sort=mais_vendidos' },
					 { palavra: 'plafon redondo sobrepor', link: '/plafon-led-sobrepor-redondo?sort=mais_vendidos' },
					 { palavra: 'luminaria embutir led', link: '/plafon-led-embutir?sort=mais_vendidos' },
					 { palavra: 'luminária de teto quadrada', link: '/plafon-led-sobrepor-quadrado?sort=mais_vendidos' },
					 { palavra: 'luminária de led de embutir', link: '/plafon-led-embutir?sort=mais_vendidos' },
					 { palavra: 'luminária embutir led', link: '/plafon-led-embutir?sort=mais_vendidos' },
					 { palavra: 'placa de led sobrepor', link: '/plafon-led-sobrepor?sort=mais_vendidos' },
 ...
 
				 {
					 ...
					 { palavra: 'trilho spot', link: '/spot-led-trilho-eletrificado' },
					 ...
					 { palavra: 'spot para lampada', link: '/spot-led-recuado?sort=mais_vendidos' },
					 { palavra: 'luminária de teto spot', link: '/spot-led-sobrepor?sort=mais_vendidos' },
					 { palavra: 'lampada g9 led', link: 'https://www.iluminim.com.br/lampada-led-halopin-g9-5w-branco-quente-220V' },
			 { palavra: 'lampada solar para jardim', link: 'https://www.iluminim.com.br/luminaria-solar-led-sensor-de-movimento-1w-prateada' },
			 { palavra: 'lâmpada recarregável', link: 'https://www.iluminim.com.br/luminaria-de-emergencia-30-leds-slim' },
			 { palavra: 'lampada vermelha', link: 'https://www.iluminim.com.br/lampada-led-bulbo-7w-residencial-vermerlho-bivolt-e27-inmetro' },
			 { palavra: 'lampada tubular led 18w', link: 'https://www.iluminim.com.br/lampada-led-tubular-t8-18w-60cm-roxo-inmetro' },
			 { palavra: 'lâmpada inteligente alexa', link: 'https://www.iluminim.com.br/lampada-led-bulbo-10w-rgb-bivolt-smart-compativel-com-alexa-elgin' },
 
					 ],
				 },
	 
				 {
					 paginas: ["/fita-de-led", "/fita-led-friday"],
					 palavras: [
					 ...
					 { palavra: 'Fita led com controle', link: '/fita-de-led' },
				 ...
				 {
					 paginas: ["/lampada-led", "/lampada-led-friday"],
					 palavras: [
				 ...
				 {
					 paginas: ["/acessorios-para-leds", "/acessorios-led-friday"],
					 palavras: [
					 { "palavra": "filtro de linha", "link": "/filtro-de-linha-6-tomadas-com-disjuntor" },
					 { "palavra": "sensor de presença", "link": "/sensor-de-presenca?sort=mais_vendidos" },
					 { "palavra": "cabo coaxial", "link": "/cabo-de-energia?sort=mais_vendidos" },
					 { "palavra": "extensão tomada", "link": "/interruptores-tomadas-led?sort=mais_vendidos" },
					 { "palavra": "dimmer", "link": "/dimmer-led?sort=mais_vendidos" },
					 { "palavra": "tomada dupla", "link": "/conjunto-tomada-distanciadas-2pt-de-embutir-10a-modular" },
					 { "palavra": "espelho de tomada", "link": "/conjunto-placa-para-1-interruptor-1-tomada" },
					 { "palavra": "soquete e27", "link": "/soquete-led?sort=mais_vendidos" },
					 { "palavra": "soquete para lampada", "link": "/soquete-led?sort=mais_vendidos" },
					 { "palavra": "lampada com sensor de presença", "link": "/sensor-presenca-soquete-e27-automatico" },
					 { "palavra": "tomada 20 amperes", "link": "/conjunto-tomada-2pt-de-embutir-20a-modular" },
					 { "palavra": "interruptor com tomada", "link": "/conjunto-interruptor-1-tecla-simples-tomada-20a-modular" },
					 { "palavra": "plug de tomada", "link": "/adaptador-soquete-lampada-led-e27-com-tomada-plug-bipino" },
					 { "palavra": "rele fotoeletrico", "link": "/rele-fotoeletrico?sort=mais_vendidos" },
					 { "palavra": "regua tomada", "link": "/filtro-de-linha-6-tomadas-com-disjuntor" },
					 { "palavra": "tomada industrial", "link": "/interruptores-tomadas-led?sort=mais_vendidos" },
					 { "palavra": "tomada preta", "link": "/interruptores-tomadas-led?sort=mais_vendidos" },
					 { "palavra": "tomada rj45", "link": "/interruptores-tomadas-led?sort=mais_vendidos" },
					 { "palavra": "fonte para fita de led", "link": "/fonte-convencional?sort=mais_vendidos" },
					 { "palavra": "soquete g9", "link": "/soquete-lampada-led-halopin-g9" },
					 { "palavra": "dimmer para led", "link": "/dimmer-led?sort=mais_vendidos" },
					 { "palavra": "soquete gu10", "link": "/soquete-lampada-led-GU10" },
					 { "palavra": "fonte para led", "link": "/fonte-convencional?sort=mais_vendidos" },
					 { "palavra": "conector fita led", "link": "/conectores-led?sort=mais_vendidos" },
					 { "palavra": "chip led 50w", "link": "/chip-de-refletor-50w-branco-frio" },
					 { "palavra": "emenda fita led", "link": "/emenda-para-fita-de-led?sort=mais_vendidos" },
					 { "palavra": "led controle remoto", "link": "/controles?sort=mais_vendidos" },
					 { "palavra": "chip de led", "link": "/chip-led?sort=mais_vendidos" },
					 { palavra: 'mini interruptor', link: '/interruptores-tomadas-led?sort=mais_vendidos' },
					 { palavra: 'fio 2 5mm flexivel', link: '/cabo-flexivel-750v-250-mm-100m-preto' },
					 { palavra: 'interruptor redondo', link: '/interruptor-simples-bolinha-de-embutir-cor-branca' },
					 { palavra: 'fio paralelo 1 5', link: '/cabo-flexivel-750v-150mm-20m-preto' },
					 { palavra: 'rele falta de fase trifasico', link: '/rele-fotoeletrico?sort=mais_vendidos' },
					 { palavra: 'rele de corrente', link: '/rele-fotoeletrico?sort=mais_vendidos' },
					 { palavra: 'fio flexível 2 e meio', link: '/cabo-flexivel-750v-250mm-10m-preto' },
					 { palavra: 'fio paralelo 6mm', link: '/cabo-flexivel-750v-400mm-20m-vermelho' },
					 { palavra: 'interruptor bipolar duplo', link: '/conjunto-interruptor-2-teclas-simples-modular' },
					 { palavra: 'conector fita led 12v', link: '/conectores-led?sort=mais_vendidos' },
					 { palavra: 'fita de led amarela com fonte', link: '/fita-led-branco-quente-5050-5-metros-com-fonte' },
					 { palavra: 'controle rgb led', link: '/controles?sort=mais_vendidos' },
					 { palavra: 'fio extensão elétrica', link: '/filtro-de-linha-3-tomadas-com-disjuntor' },
					 { palavra: 'fio e cabos elétricos', link: '/cabo-de-energia?sort=mais_vendidos' },
					 { palavra: 'cabo de 1.5 mm', link: '/cabo-flexivel-750v-150mm-20m-preto' },
					 { palavra: 'cabo de rede eletrica', link: '/cabo-de-energia?sort=mais_vendidos' },
					 ],
				 },
	 
				 {
					 paginas: ["/pendente", "/pendente-led-friday"],
					 palavras: [
				 ...
				 {
					 paginas: ["/luminarias-publicas-led"],
					 palavras: [
				 ...
				 {
					 paginas: ["/luminaria-de-mesa", "/luminaria-abajur"],
					 palavras: [
					 { palavra: 'abajur de chão', link: '/luminaria-de-chao' },
					 { palavra: 'abajur para quarto casal', link: '/luminaria-de-mesa-abajur-base-cilindro-de-vidro-cupula' },
					 { palavra: 'luminaria de chão para sala', link: '/luminaria-de-chao' },
					 { palavra: 'abajur tiffany', link: '/luminaria-de-mesa' },
					 { palavra: 'abajur de cristal', link: '/luminaria-de-mesa-abajur-base-prisma-de-vidro-cupula' },
					 { palavra: 'abajur ceramica', link: '/luminaria-de-mesa-abajur-classic-p-cupula-conica-palermo' },
					 { palavra: 'abajur de pé alto para sala', link: '/luminaria-de-chao' },
					 { palavra: 'abajur para quarto criado mudo', link: '/luminaria-de-mesa-abajur-base-diamante-de-vidro-cupula' },
					 { palavra: 'abajur cogumelo', link: '/luminaria-de-mesa-abajur-mini-office-vermelho' },
					 { palavra: 'abajur vidro', link: '/luminaria-de-mesa-abajur-base-prisma-de-vidro-cupula' },
					 { palavra: 'abajur verde', link: '/luminaria-de-mesa-led-14-leds-3-tons-touch-verde' },
					 { palavra: 'abajur quarto infantil', link: '/luminaria-infantil-abajur-led-dinossauro-1w-luz-noturna' },
					 { palavra: 'luminária de mesa para sala', link: '/luminaria-de-mesa-articulada-preto' },
					 { palavra: 'luminaria bancada', link: '/luminaria-de-mesa-articulada-preto' },
					 { palavra: 'abajur para bebe', link: '/luminaria-infantil-abajur-unicornio-led-luz-noturna-luminoso' },
					 { palavra: 'lustre para mesa redonda', link: '/luminaria-de-mesa-abajur-mini-office-amarelo' },
					 { palavra: 'luminaria pelicano', link: '/luminaria-de-mesa-24-leds-4w-abajur-dobravel-branco-frio-branco-e-preto' },
					 { palavra: 'abajur de toque', link: '/luminaria-de-mesa-led-14-leds-3-niveis-touch-azul' },
					 { palavra: 'abajur branco para quarto', link: '/luminaria-de-mesa-led-14-leds-3-niveis-touch-azul' },
					 { palavra: 'luminária de mesa decorativa', link: '/luminaria-lua-abajur-led-3-cores-touch-com-entrada-usb' },
					 /*{"palavra": "luminaria de mesa articulada", "link": "/luminaria-de-mesa?sort=mais_vendidos" },
					 {"palavra": "luminaria de mesa de jantar", "link": "/pendente?sort=mais_vendidos" },
					 {"palavra": "luminarias de mesa para quarto", "link": "/luminaria-de-mesa?sort=mais_vendidos" },
					 {"palavra": "luminaria de mesa com garra", "link": "/luminaria-led-para-leitura-livro-pc-dj-mesa-partitura" },
					 {"palavra": "luminaria de mesa infantil", "link": "/luminaria-de-mesa?sort=mais_vendidos" },
					 {"palavra": "luminaria de mesa preta", "link": "/buscar?q=lumin%C3%A1ria+mesa+preta" },
					 {"palavra": "luminaria de mesa rosa", "link": "/luminaria-touch-sem-fio-3-niveis-luz-14-leds-rosa" },
					 {"palavra": "luminaria de mesa branca", "link": "/buscar?q=lumin%C3%A1ria+mesa+branca" },
					 {"palavra": "lampada para luminaria de mesa", "link": "/lampada-led" },
					 {"palavra": "luminaria de mesa recarregável", "link": "/buscar?q=lumin%C3%A1ria+mesa+recarreg%C3%A1vel" },
					 {"palavra": "luminaria de mesa azul", "link": "/luminaria-de-mesa-led-4w-portatil-com-entrada-usb-azul" },
					 {"palavra": "luminaria de mesa flexivel", "link": "/luminaria-de-mesa?sort=mais_vendidos" },
					 {"palavra": "luminaria de mesa moderna", "link": "/luminaria-de-mesa?sort=mais_vendidos" },
					 {"palavra": "luminaria de mesa usb", "link": "/buscar?q=lumin%C3%A1ria+usb" },
					 {"palavra": "luminaria de mesa articulada com garra", "link": "/luminaria-led-para-leitura-livro-pc-dj-mesa-partitura" },
					 {"palavra": "luminaria de mesa led touch", "link": "/buscar?q=lumin%C3%A1ria+touch" },
					 {"palavra": "luminaria de mesa verde", "link": "/luminaria-touch-sem-fio-3-niveis-luz-14-leds-verde" },
					 {"palavra": "preço de luminaria de mesa", "link": "/luminaria-de-mesa?sort=%2Bpreco" },
					 {"palavra": "luminaria de mesa colorida", "link": "/luminaria-de-mesa?sort=mais_vendidos" },
					 {"palavra": "luminaria de mesa laranja", "link": "/luminaria-led-usb-para-notebook-laranja" }*/
					 ],
				 },
	 
				 {
					 paginas: ["/arandela-led"],
					 palavras: [
					 { palavra: 'arandela led externa', link: '/arandela-externa-led?sort=mais_vendidos' },
					 { palavra: 'luminaria tartaruga', link: '/luminaria-arandela-led-5w-sobrepor-tartaruga-branco-frio-branco' },
					 { palavra: 'luminaria parede', link: '/arandela-externa-led?sort=mais_vendidos' },
					 { palavra: 'arandela de parede', link: '/arandela-led?sort=mais_vendidos' },
					 { palavra: 'arandela interna', link: '/arandela-led?sort=mais_vendidos' },
					 { palavra: 'arandela de parede externa', link: '/arandela-externa-led?sort=mais_vendidos' },
					 { palavra: 'arandela para banheiro', link: '/luminaria-arandela-led-5w-supimpa-branco-quente-branco' },
					 { palavra: 'arandela preta', link: '/luminaria-arandela-led-6w-rischi-externa-branco-quente-preto' },
					 { palavra: 'arandela para quarto', link: '/lumiaria-arandela-led-frisada-branca' },
					 { palavra: 'arandela rústica', link: '/luminaria-arandela-led-40w-bojo-madeira-ipe' },
					 ...
					 { palavra: 'arandela cabeceira', link: '/luminaria-arandela-led-quadrada-3w-abs-branco-quente' },
					 { palavra: 'Arandela 2 fachos', link: '/luminaria-arandela-led-4w-externa-branco-quente-branca' },
					 { palavra: 'Arandela le', link: '/arandela-led?sort=mais_vendidos' },
					 { palavra: 'arandela bola', link: '/luminaria-arandela-led-12w-redonda-externa-branco-quente-branca' },
					 { palavra: 'arandela muro', link: '/luminaria-arandela-led-6w-rischi-externa-branco-quente-preto' },
					 { palavra: 'arandela branca', link: '/luminaria-arandela-led-6w-externa-rgb-colorido-branca' },
				 ...
				 {
					 paginas: ["/refletor-micro-led-slim"],
					 palavras: [
					 { palavra: 'refletor 100w', link: '/refletor-led-100w' },
					 { palavra: 'refletor led 30w', link: '/refletor-led-30w' },
					 { palavra: 'refletor solar', link: '/refletor-led-solar?sort=mais_vendidos' },
				 ...
				 {
					 paginas: ["/lustre", "/lustre-led-friday"],
					 palavras: [
					 { palavra: 'Lustre pendente', link: '/lustre-pendente?sort=ultimos_produtos' },
 ...
 
				 {
					 ...
					 { palavra: 'Fita led black friday', link: '/fita-de-led' },
					 { palavra: 'Plafon black friday', link: '/plafon-led?sort=mais_vendidos' },
					 { palavra: 'Spot black friday', link: '/spots' },
					 ...
					 { palavra: 'Trilho black friday', link: '/spot-led-trilho-eletrificado' },
					 { palavra: 'Lustre black friday', link: '/lustre' },
					 { palavra: 'lampada led black friday', link: '/lampada-led' },
				 ...
				 {
					 paginas: [
					 '/fita-led-branco-morno',
					 '/fita-led-azul',
					 '/fita-led-vermelha',
					 '/fita-led-verde',
					 '/fita-led-ultravioleta',
					 '/fita-led-rosa',
					 '/fita-led-12v',
					 '/mangueiras-led',
					 '/kit-fita-led'
 ...
 
				 {
					 ...
					 '/spot-led-quadrado',
					 '/spot-led-redondo', 
					 '/mini-spot-led-quadrado',
					 '/mini-spot-led-redondo',
					 '/spot-led-colorido-',
					 '/balizador-led',
					 '/spot-led-sobrepor',
					 '/kits-spots-led-dicroica'
					 ],
					 palavras: [
					 { palavra: 'lampada spot', link: '/par-led?sort=mais_vendidos' },
					 { palavra: 'spot led embutir quadrado', link: '/spot-led-quadrado?sort=mais_vendidos' },
 ...
 
				 {
					 ...
					 '/lampada-led-rgb',
					 '/lampada-led-bolinha',
					 '/lampada-led-globo-balloon',
					 '/dicroica-led',
					 '/lampada-led-prato',
					 '/lampada-led-wi-fi',
					 '/kit-lampadas-de-led',
					 '/lampada-led-colorida',
					 ],
					 palavras: [
					 { palavra: 'lampada led', link: '/lampada-led' },
					 { palavra: 'lampada g9 led', link: '/lampada-led-halopin-g9-5w-branco-quente-220V' },
					 { palavra: 'lampada solar para jardim', link: '/luminaria-solar-led-sensor-de-movimento-1w-prateada' },
					 { palavra: 'lâmpada recarregável', link: '/luminaria-de-emergencia-30-leds-slim' },
					 { palavra: 'lampada vermelha', link: '/lampada-led-bulbo-7w-residencial-vermerlho-bivolt-e27-inmetro' },
 ...
 
				 {
					 ...
					 '/chip-led',
					 '/driver-refletor-led',
					 '/controle-refletor-led',
					 '/fonte-chaveada-led',
					 '/fonte-convencional',
					 '/conectores-led',
					 '/dimmer-led',
					 '/emenda-para-fita-de-led',
					 '/controle-fita-led',
					 '/amplificadores-led',
					 '/driver-plafon-led',
					 '/soquete-led',
					 '/sensor-de-presenca',
					 '/rele-fotoeletrico',
					 '/acessorios-camera-led',
					 '/interruptores-tomadas-led',
					 '/cabo-de-energia'
					 ],
					 palavras: [
					 { palavra: 'mini interruptor', link: '/interruptores-tomadas-led?sort=mais_vendidos' },
				 ...
				 {
					 paginas: ['/led-para-dormitorios'],
					 palavras: [
					 { palavra: 'lustre quarto casal', link: '/lustre-pendente?sort=mais_vendidos' },
					 { palavra: 'lustre quarto bebe', link: '/lustre-plafon?sort=mais_vendidos' },
					 { palavra: 'luminaria quarto casal', link: '/pendente?sort=mais_vendidos' },
					 { palavra: 'luminária de teto quarto', link: '/luminarias-led?sort=mais_vendidos' },
					 { palavra: 'lustre para quarto casal', link: '/lustre' },
					 { palavra: 'pendente de cabeceira', link: '/kit-2-pendente-aramado-bronze' },
					 { palavra: 'pendente cabeceira quarto casal', link: '/kit-2-pendente-aluminio-preto-cone' },
					 { palavra: 'lustre quarto de bebe', link: '/lustre-plafon?sort=mais_vendidos' },
					 { palavra: 'lustre quarto feminino', link: '/lustre-cristal?sort=mais_vendidos' },
					 { palavra: 'luminária de parede infantil', link: '/lustre-de-parede?sort=mais_vendidos' },
					 { palavra: 'led na parede do quarto', link: '/lustre-de-parede?sort=mais_vendidos' },
					 { palavra: 'arandela parede quarto', link: '/arandela-led?sort=mais_vendidos' },
					 { palavra: 'luz led colorida para quarto', link: '/lampadas-inteligentes?sort=mais_vendidos' },
					 { palavra: 'led no quarto teto', link: '/luminaria-de-teto?sort=mais_vendidos' },
					 { palavra: 'lustre rose gold quarto', link: '/pendente-cristal-bolhas-led-7w-30cm' },
					 { palavra: 'pendente duplo para quarto', link: '/pendente-perola-arco-preto-fosco-g45-2-lampadas' },
					 ]
				 },
 
				 {
				 paginas: ['/frete-gratis'],
				 palavras: [
					 { palavra: 'kit refletor led 50w', link: 'https://www.iluminim.com.br/kit-5-refletor-holofote-microled-slim-50w-branco-frio' },
					 { palavra: 'kit plafon led sobrepor', link: 'https://www.iluminim.com.br/kit-plafon-led?sort=mais_vendidos' },
					 { palavra: 'acessorios frete gratis', link: 'https://www.iluminim.com.br/frete-gratis-acessorios-led?sort=mais_vendidos' },
					 { palavra: 'frete gratis fios', link: 'https://www.iluminim.com.br/cabo-de-energia?sort=mais_vendidos' },
					 { palavra: 'kit plafon embutir', link: 'https://www.iluminim.com.br/plafon-led-embutir-quadrado?sort=mais_vendidos' },
					 { palavra: 'refletor 200w', link: 'https://www.iluminim.com.br/kit-5-refletor-holofote-microled-slim-200w-branco-frio' },
					 { palavra: 'lustre em promocao frete gratis', link: 'https://www.iluminim.com.br/lustre' },
					 { palavra: 'regras frete gratis', link: 'https://www.iluminim.com.br/pagina/condicoes-de-frete-gratis.html' },
				 ]
				 },
			 ]
 
			 let buscarPalavras = config.filter(item => item.paginas.includes(window.location.pathname));
 
			 if(buscarPalavras.length == 0) return;
 
			 return buscarPalavras[0].palavras;
		  ...
		  gerarHTML(){
				...
				let convertObjectToHTML = (local) => {
					 let html = palavras.map(item=> {
						 return `
						 <li>
							 <a onclick="ga('send', 'event', 'Categoria -> ${window.location.pathname} | Produtos mais procurados lateral', 'click', 'Termo -> ${item.palavra}')" href="${item.link}" title="${item.palavra}" alt="${item.palavra}" ${item.blank ? 'target="_blank" rel="noopener"' : ''}>
				...
				return {
				   ...
				   html_palavras_lateral: `
					  <div class="lateral outras filtro-coluna filtro-lista-personalizada palavras-mais-buscadas-lateral">
							<div class="filtro lista borda-principal">
							   <h4 class="titulo cor-secundaria">Produtos mais procurados</h4>
							   <div class="atributo-lista">
								  <ul>
										${convertObjectToHTML('lateral')}
								  </ul>
							   </div>
							</div>
					  </div>
				   ...
				   ['/spots-led-']: {
					  ...
					  termos: [
							...
							},
							{
							   ...
							   link: '/spot-led-trilho-eletrificado'
							},
					  ]
				   ...
				   <div class="avalicoes-categoria">
					  ...
					  <div class="avalicoes-categoria-rodape">
							<div class="avalicoes-categoria-trustvox">
							   ...
							   <div class="avalicoes-categoria-trustvox-logo"><img src="https://cdn.awsli.com.br/257/257163/arquivos/selo-ra-trustvox-18-01-22.png"></div>
							</div>
					  </div>
	...
	cronometroCategoria(){
	   ...
	   let banner_cronometro = {
		  ...
		  ['/pendente']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/116131332/fc38c32657.jpg',
			 link: '/pendente-redondo-led-bolhas-vidro-1m',
			 nome_1: 'Pendente Redondo LED',
			 nome_2: 'Bolhas Vidro 1m',
			 porcentagem_desconto: '43',
		  },
		  ...
		  ['/spots']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/41610089/57f265c152.jpg',
			 link: '/spot-led-smd-7w-redondo-branco-quente',
			 nome_1: 'Spot LED SMD 7W',
			 nome_2: 'Redondo Branco Quente',
		  ...
		  ['/lampada-led']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/77090353/ff7b69a600.jpg',
		  ...
		  ['/lampada-led-tubular']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/16216387/a730affaa3.jpg',
			 link: '/lampada-led-tubular-t5-9w-60cm-branco-frio-inmetro',
			 nome_1: 'Lâmpada LED Tubular',
			 nome_2: 'T5 9w - 60cm - Branco Frio | Inmetro',
			 porcentagem_desconto: '32',
		  },
		 ...
		 ['/refletor-micro-led-smd-rgb']: {
			imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/100566637/6e501ece64.jpg',
		 ...
		 ['/refletor-led-smd-ultra-thin']: {
			imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/32162842/6a4c3f5962.jpg',
			link: '/kit-5-refletor-microled-ultra-thin-200w-branco-frio-black-type',
			nome_1: 'Kit 5 Refletor MicroLED',
			nome_2: 'Ultra Thin 200W Branco Frio Black Type',
			porcentagem_desconto: '85',
		 },
		 ...
		 ['/refletor-micro-led-ultra-thin-verde']: {
			imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/39523790/38aa982bd8.jpg',
		 ...
		 ['/plafon-led']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/12615355/5ec9f9ed58.jpg',
			 link: '/luminaria-plafon-60x60-48w-led-embutir-branco-frio-borda-branca',
			 nome_1: 'Luminária Plafon 60x60 48W',
			 nome_2: 'LED Embutir Branco Frio Borda Branca',
			 porcentagem_desconto: '50',
		 },
 
		 ['/baixou-o-preco']: {
			 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/cat-baixou-preco-10-01-22.jpg',
			 link: '/pendente-aluminio-cone-rose-gold-e27',
			 nome_1: 'Pendente Alumínio',
			 nome_2: 'Cone Rose Gold E27',
		 ...
		 ['/compre-por-ambiente']: {
			 ...
			 link: '/luminaria-plafon-25w-led-sobrepor-branco-frio-quadrado',
			 nome_1: 'Luminária Plafon 25w LED',
			 nome_2: 'Sobrepor Branco Frio',
			 porcentagem_desconto: '17',
		 },
 
		 ['/arandela-led']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/36942169/49152b4184.jpg',
			 link: '/luminaria-arandela-led-8w-retangular-branco-quente-preto',
			 nome_1: 'Luminária Arandela LED',
			 nome_2: '8W Retangular Branco Quente Preto',
			 porcentagem_desconto: '39',
		 },
 
		 ['/led-para-sala-de-estar']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/112939195/9d3d4a1084.jpg',
			 link: '/pendente-aluminio-cone-branco-e27',
			 nome_1: 'Pendente Alumínio',
			 nome_2: 'Cone Branco E27',
			 porcentagem_desconto: '66',
		 },
 
		 ['/plafon-led-borda-infinita']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/65878981/180ea1d905.jpg',
			 link: '/luminaria-plafon-22x22-led-32w-embutir-branco-frio-borda-infinita',
			 nome_1: 'Luminária Plafon 22x22 LED',
			 nome_2: '32W Embutir Branco Frio Borda Infinita',
			 porcentagem_desconto: '17',
		 },
 
		 ['/led-para-sala-de-jantar']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/109458450/c1d0db77ca.jpg',
			 link: '/luminaria-de-mesa-abajur-base-circular-de-vidro-cupula',
			 nome_1: 'Luminária De Mesa Abajur',
			 nome_2: 'Base Circular de Vidro Cúpula',
			 porcentagem_desconto: '67',
		 },
 
		 ['/luminaria-plafon-led-para-banheiros']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/43072722/e53be8a200.jpg',
			 link: '/spot-led-smd-7w-quadrado-branco-frio',
			 nome_1: 'Spot LED SMD 7W',
			 nome_2: 'Quadrado Branco Frio',
			 porcentagem_desconto: '68',
		 },
 
		 ['/led-para-cozinha']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/45495735/609f2d2fdd.jpg',
			 link: '/pendente-cone-branco-e27',
			 nome_1: 'Pendente Cone',
			 nome_2: 'Branco E27',
			 porcentagem_desconto: '32',
		 },
 
		 ['/led-para-corredores']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/24762444/53a706d28d.jpg',
			 link: '/lampada-led-bulbo-9w-residencial-branco-frio-bivolt',
			 nome_1: 'Lâmpada LED Bulbo 9W',
			 nome_2: 'Residencial Branco Frio Bivolt',
			 porcentagem_desconto: '69',
		 },
 
		 ['/led-para-escritorio']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/35493677/661b651a9b.jpg',
			 link: '/lampada-led-tubular-t8-36w-240m-branco-neutro',
			 nome_1: 'Lampada LED Tubular T8 36w',
			 nome_2: '2,40m Branco Neutro | Inmetro',
			 porcentagem_desconto: '13',
		 },
 
		 ['/led-para-estacionamento']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/18351034/3e65bbd3f3.jpg',
			 link: '/lampada-led-alta-potencia-50w-branco-frio',
			 nome_1: 'Lampada LED Alta Potencia',
			 nome_2: '50W Branco Frio | Inmetro',
			 porcentagem_desconto: '69',
		 },
		 ...
		 ['/led-para-garagem']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/35278847/f5153f6607.jpg',
			 link: '/lampada-led-alta-potencia-100-w-branco-frio',
			 nome_1: 'Lampada LED Alta Potencia',
			 nome_2: '100W Branco Frio | Inmetro',
			 porcentagem_desconto: '26',
		 },
 
		 ['/led-para-jardim']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/19626953/8cffcd2bca.jpg',
			 link: '/espeto-de-jardim-led-7w-verde',
			 nome_1: 'Espeto de Jardim LED',
			 nome_2: '7W Verde',
			 porcentagem_desconto: '61',
		 },
 
		 ['/led-para-outdoor']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/26482900/bf74976e5e.jpg',
			 link: '/refletor-holofote-microled-100w-branco-frio',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 100W Branco Frio',
			 porcentagem_desconto: '77',
		 },
 
		 ['/led-para-quadra']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/24686236/260657b249.jpg',
			 link: '/refletor-microled-ultra-thin-50w-branco-frio-preto',
			 nome_1: 'Refletor MicroLED Ultra',
			 nome_2: 'Thin 50W Branco Frio Black Type',
			 porcentagem_desconto: '73',
		 },
		 ...
		 ['/kits-spots-led-dicroica']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/59306982/289bc02c22.jpg',
			 link: '/kit-10-spot-led-smd-5w-quadrado-branco-frio',
			 nome_1: 'Kit 10 Spot LED SMD 5W',
			 nome_2: ' Quadrado Branco Frio',
		 ...
		 ['/frete-gratis']: {
			 ...
			 link: '/refletor-micro-led-slim-200w-branco-frio',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 200W Branco Frio',
			 porcentagem_desconto: '83',
		 },
 
		 ['/refletor-led-600w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/46552110/ddbcc77d9f.jpg',
			 link: '/refletor-holofote-microled-slim-600w-branco-frio',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 600W Branco Frio',
			 porcentagem_desconto: '79',
		 },
 
		 ['/refletor-led-500w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/27546702/b50c3d9d11.jpg',
			 link: '/refletor-holofote-microled-slim-500w-branco-frio',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 500W Branco Frio',
			 porcentagem_desconto: '80',
		 },
		 ...
		 ['/refletor-led-400w']: {
			 ...
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 400W Branco Frio',
			 porcentagem_desconto: '79',
		 },
 
		 ['/refletor-led-300w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/27108886/0e5ed29f6d.jpg',
			 link: '/refletor-holofote-micro-led-slim-300w-branco-frio',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 300W Branco Frio',
			 porcentagem_desconto: '87',
		 },
		 ...
		 ['/refletor-led-150w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/32520056/e09fb15956.jpg',
			 link: '/refletor-holofote-microled-slim-150w-branco-quente',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 150W Branco Quente',
			 porcentagem_desconto: '70',
		 },
		 ...
		 ['/refletor-led-100w']: {
			 ...
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 100W Branco Frio',
			 porcentagem_desconto: '81',
		 },
 
		 ['/refletor-led-50w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/27728386/991b9c29d7.jpg',
			 link: '/refletor-holofote-microled-100w-branco-frio',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 100W Branco Frio',
			 porcentagem_desconto: '80',
		 ...
		 ['/refletor-led-30w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/27730580/97aed87a39.jpg',
			 link: '/refletor-holofote-microled-slim-30w-branco-frio-ip66',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 30W Branco Frio',
			 porcentagem_desconto: '74',
		 },
 
		 ['/refletor-led-20w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/34857435/2a74c121db.jpg',
			 link: '/refletor-holofote-microled-slim-20w-branco-quente',
			 nome_1: 'Refletor Holofote MicroLED',
			 nome_2: 'Slim 20W Branco Quente',
			 porcentagem_desconto: '50',
		 },
 
		 ['/refletor-led-10w']: {
			 imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/24684967/b4af096bae.jpg',
			 link: '/refletor-micro-led-ultra-thin-10w-branco-frio-preto',
			 nome_1: 'Refletor MicroLED Ultra Thin',
			 nome_2: '10W Branco Frio Black Type',
			 porcentagem_desconto: '67',
		 },
	...
	navegacaoCategoria(){
	   ...
	   let NavegacaoCategoria = {
		  ...
		  gerarObjeto(){
				 ...
				 let objeto = [
 
					 {
						 ...
						 '/plafon-led-sobrepor', 'luminaria-de-teto',
						 '/plafon-led', '/plafon-led-embutir'
						 ],
						 navegacao: [
						 [
							 {
						 ...
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/PG-R36WBN-16-12-21.png',
								 link: '/luminaria-de-teto?sort=mais_vendidos',
								 nome: 'Luminária de<br>Teto'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/PS-R36WBN-16-12-21.png',
								 link: '/plafon-led?sort=mais_vendidos',
								 nome: 'Plafon<br>LED'
							 },
						 ],
						 ...
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/HW-07-06-05-2022.png',
					 ...
					 {
						 categorias: ['/plafon-led-colorido'],
						 navegacao: [
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Plafon LED Colorido-20-08-21.jpg',
									 link: '/plafon-preto?sort=mais_vendidos',
									 nome: 'Plafon LED Preto'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/plafon-led-marrom-27-04-2022.png',
									 link: '/plafon-led-marrom?sort=mais_vendidos',
									 nome: 'Plafon LED Marrom'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/plafon-led-cinza-27-04-2022.png',
									 link: '/plafon-led-cinza?sort=mais_vendidos',
									 nome: 'Plafon LED Cinza'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/plafon-led-vermelho-27-04-2022.png',
									 link: '/plafon-led-vermelho?sort=mais_vendidos',
									 nome: 'Plafon LED Vermelho'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/plafon-led-dourado-27-04-2022.png',
									 link: '/buscar?q=Plafon+LED+Dourado',
									 nome: 'Plafon LED Dourado'
								 },
							 ],
						 ],
					 },
					 {
						 categorias: ['/spot-led-colorido-'],
						 navegacao: [
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-preto-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Preto',
									 nome: 'Spot Preto'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-amarelo-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Amarelo',
									 nome: 'Spot Amarelo'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-verde-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Verde',
									 nome: 'Spot Verde'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-azul-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Azul',
									 nome: 'Spot Azul'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-turquesa-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Turquesa',
									 nome: 'Spot Turquesa'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-rosa-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Rosa',
									 nome: 'Spot Rosa'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-cinza-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Cinza',
									 nome: 'Spot Cinza'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/base-spot-marrom-27-04-2022.png',
									 link: '/buscar?q=Spot+Embutir+Recuado+Marrom',
									 nome: 'Spot Marrom'
								 },
							 ],
						 ],
 ...
 
					 {
						 ...
						 navegacao: [
							 ...
							 [
								 ...
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/foto-mangueira-led-06-12-21.png',
 ...
 
					 {
						 ...
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/lustre-pendente-28-03-2022.png',
						 ...
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/lustre-plafon-28-03-2022.png',
						 ...
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/lustre-led-classico-29-03-2022.png',
					 ...
					 {
						 categorias: ['/compre-por-ambiente', '/led-para-area-interna', '/led-para-dormitorios', '/led-para-area-externa', '/led-para-sala-de-estar', '/luminaria-plafon-led-para-banheiros', '/led-para-sala-de-jantar', '/led-para-corredores', '/led-para-garagem', '/led-para-cozinha', '/led-para-jardim', '/led-para-escritorio', '/led-para-quadra'],
						 classePersonalizada: 'navegacao-ambiente',
						 navegacao: [
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_area_interna.png',
								 link: '/led-para-area-interna?sort=mais_vendidos',
								 nome: 'LED para<br>Área Interna'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_quarto.png',
								 link: '/led-para-dormitorios?sort=mais_vendidos',
								 nome: 'LED para<br>Quarto'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_area_externa.png',
								 link: '/led-para-area-externa?sort=mais_vendidos',
								 nome: 'LED para<br>Área Externa'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_sala_de_estar.png',
								 link: '/led-para-sala-de-estar?sort=mais_vendidos',
								 nome: 'LED para<br>Sala de Estar'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_banheiro.png',
								 link: '/luminaria-plafon-led-para-banheiros?sort=mais_vendidos',
								 nome: 'LED para<br>Banheiro'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_sala_de_jantar.png',
								 link: '/led-para-sala-de-jantar',
								 nome: 'LED para<br>Sala de Jantar'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_corredor.png',
								 link: '/led-para-corredores?sort=mais_vendidos',
								 nome: 'LED para<br>Corredor'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_garagem.png',
								 link: '/led-para-garagem?sort=mais_vendidos',
								 nome: 'LED para<br>Garagem'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_cozinha.png',
								 link: '/led-para-cozinha?sort=mais_vendidos',
								 nome: 'LED para<br>Cozinha'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_jardim.png',
								 link: '/led-para-jardim?sort=mais_vendidos',
								 nome: 'LED para<br>Jardim'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_escritorio.png',
								 link: '/led-para-escritorio?sort=mais_vendidos',
								 nome: 'LED para<br>Escritório'
							 },
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/14-01-22-led_para_quadra.png',
								 link: '/led-para-quadra?sort=mais_vendidos',
								 nome: 'LED para<br>Quadra'
							 },
						 ],
						 ],
					 },
			 
					 {
						 categorias: [
						 '/frete-gratis',
						 '/frete-gratis-refletor-led',
						 '/frete-gratis-luminaria-led',
						 '/frete-gratis-spot-led',
						 '/frete-gratis-fita-led',
						 '/frete-gratis-lampada-led',
						 '/frete-gratis-acessorios-led',
						 ],
						 navegacao: [
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/refletor-micro-led-slim-18-08-21.png',
								 link: '/frete-gratis-refletor-led?sort=mais_vendidos',
								 nome: 'Frete Grátis<br>Refletores LED'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/plafon-led-sobrepor-19-08-21.png',
								 link: '/frete-gratis-luminaria-led?sort=mais_vendidos',
								 nome: 'Frete Grátis<br>Luminárias LED'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/spot-led-quadrado-30-09-21.png',
								 link: '/frete-gratis-spot-led?sort=mais_vendidos',
								 nome: 'Frete Grátis<br>Spots LED'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Fita-LED-Branco-Quente-19-08-2021-menu.png',
								 link: '/frete-gratis-fita-led?sort=mais_vendidos',
								 nome: 'Frete Grátis<br>Fitas LED'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Bulbo-19-08-2021.png',
								 link: '/frete-gratis-lampada-led?sort=mais_vendidos',
								 nome: 'Frete Grátis<br>Lâmpadas LED'
							 },
						 ],
						 [
							 {
								 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/CB-FL-2-5-BR-100M-28-09-21.png',
								 link: '/frete-gratis-acessorios-led?sort=mais_vendidos',
								 nome: 'Frete Grátis<br>Acessórios LED'
							 },
						 ],
						 ],
					 },
 
					 {
						 ...
						 navegacao: [
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/PG-Q25WBF-23-05-2022.png',
									 link: '/lancamento-plafon-led-?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Plafons LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/refletor-micro-led-slim-18-08-21.png',
									 link: '/lancamento-refletor-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Refletores LED'
								 },
							 ],
							 [
								 {
							 ...
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Bulbo-19-08-2021.png',
									 link: '/lancamento-lampada-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Lâmpadas LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/PS-Q18WBF-23-05-2022.png',
									 link: '/lancamento-luminarias-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Luminárias LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/lustre-led-classico-29-03-2022.png',
									 link: '/lustre-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Lustre LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/Pendente Aramado-19-08-21.png',
									 link: '/lancamento-pendente?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Pendentes LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/cameras-led-23-05-2022.png',
									 link: '/lancamento-camera-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Câmeras LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/festa-led-23-05-2022.png',
									 link: '/lancamento-festa-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Festa LED'
								 },
							 ],
							 [
								 {
									 imagem: 'https://cdn.awsli.com.br/257/257163/arquivos/CB-FL-2-5-BR-100M-28-09-21.png',
									 link: '/lancamento-acessorios-led?sort=ultimos_produtos',
									 nome: 'Lançamentos<br>Acessórios LED'
								 },
							 ],
		  ...
		  gerarHTML(){
				...
				let navegacao = objeto.navegacao.map(item=> {
				   ...
				   let htmlItems = item.map(categoria=> {
					  ...
					  return `
						 <div class="navegacao-categoria-item ${window.location.pathname == categoria.link.split('?')[0] ? 'navegacao-active' : ''} ${categoria.imagem ? `` : `navegacao-sem-imagem` }">
				...
				return `
				   <div class="navegacao-categoria ${objeto.classePersonalizada ? objeto.classePersonalizada : ''}">
		  ...
		  ativarCarousel(){
				...
				setTimeout(() => {
				   $('.navegacao-categoria .carousel-target').trigger('refresh.owl.carousel');
				},200);
	...
	navegacaoCategoriaSimples(){
 
	   let NavegacaoCategoriaSimples = {
		  ...
		  gerarObjeto(){
				...
				let objeto = [
 
				   {
					  categorias: [
						 '/lampada-led-tubular', 
						 '/lampada-led-tubular-60cm',
						 '/lampada-led-tubular-1-20m',
						 '/lampada-led-tubular-2-40m'
					  ],
					  posicaoPersonalizada: {
						 ['/lampada-led-tubular']: '.listagem .listagem-linha:nth-child(3)'
					  },
					  navegacao: [
						 {
							link: '/lampada-led-tubular-60cm?sort=mais_vendidos',
							nome: 'Lâmpada LED Tubular 60cm'
						 },
					  {
							link: '/lampada-led-tubular-1-20m?sort=mais_vendidos',
							nome: 'Lâmpada LED Tubular 1,20m'
						 },
						 {
							link: '/lampada-led-tubular-2-40m?sort=mais_vendidos',
							nome: 'Lâmpada LED Tubular 2,40m'
						 },
					  ]
				   },
 
				   {
					  categorias: [
						 '/lampada-led',
						 /*'/kit-lampadas-de-led', 
						 '/lampadas-decorativas',
						 '/lampadas-inteligentes',
						 '/lampada-led-colorida'*/
					  ],
					  navegacao: [
						 {
							link: '/kit-lampadas-de-led?sort=mais_vendidos',
							nome: 'Kit Lâmpadas LED'
						 },
						 {
							link: '/lampadas-decorativas?sort=mais_vendidos',
							nome: 'Lâmpadas Decorativas'
						 },
						 {
							link: '/lampadas-inteligentes?sort=mais_vendidos',
							nome: 'Lâmpadas Inteligentes'
						 },
						 {
							link: '/lampada-led-colorida?sort=mais_vendidos',
							nome: 'Lâmpadas Colorida'
						 },
					  ]
				   },
		  ...
		  gerarHTML(objeto){
				...
				let navegacao = objeto.navegacao.map(categoria=> {
				...
				return `
				   <div class="navegacao-categoria navegacao-simples">
					  <div class="navegacao-categoria-conteudo">
							<div class="navegacao-categoria-lista">${navegacao}</div>
					  </div>
				   </div>
				`;
		  ...
		  renderizar(){
				...
				let html = this.gerarHTML(objeto);
 
				if(objeto.posicaoPersonalizada){
 
				   let seletor = objeto.posicaoPersonalizada[window.location.pathname];
				   
				   if(seletor){
					  return $(seletor).after(html);
				   }
	   ...
	   NavegacaoCategoriaSimples.renderizar();
			 ...
			 let objeto = {
				...
				['881697']: { //id do ambiente
				   html: `
					  ...
					  Não perca tempo e adquira agora os melhores Plafons LED do mercado, obtendo economia, energia e qualidade incomparável. Fique atento: Todos os nossos Plafons de LED de embutir e sobrepor, possuem fator potência real, alto índice de reprodução de cor, nitidez máxima na geração de luz limpa e todos os itens para funcionamento imediato após a instalação.
					  <br><br>Ainda, todos os nossos produtos são testados antes do envio e possuem acondicionamento adequado, através de embalagens personalizadas e demais itens de segurança, garantindo uma entrega perfeita e uma experiência de compra amplamente satisfatória. Descubra agora mesmo a tecnologia LED na Iluminim e faça parte da maior loja de LEDs do País. Conheça tipos de iluminação LED ideais para cada ambiente, <a target="_blank" href="http://blog.iluminim.com.br/conheca-os-tipos-de-iluminacao-led-ideais-para-cada-tipo-de-ambiente/">Clique aqui!</a>
				   `,
				},
 
				['2945649']: { // led friday
				   html: `
				   <h2>As vantagens da lâmpada LED para a sua casa</h2>
				   <p>As melhores ofertas de LED do país estão na Iluminim! Vamos conhecer um pouco mais sobre as vantagens em iluminação led. Você, provavelmente, tem visto muito falar em lâmpadas de LED e no quão vantajosas são elas quando comparadas aos outros tipos de iluminação. Hoje, o LED é a tecnologia mais inovadora no mercado de iluminação.</p>
				   <p>Que tal saber um pouco mais sobre essa nova tecnologia e conhecer as reais vantagens dela? Confira, abaixo, alguns motivos para investir imediatamente em iluminação de LED</p>
 
				   <h2>Baixo custo</h2>
				   <p>Essa é a característica mais atrativa quando o assunto é iluminação. A grande vantagem da lâmpada de LED é a economia de energia que ela proporciona de até 80%. Isso porque, o diodo tem uma boa capacidade luminosa fazendo com que a produção de luz seja maior usando menos energia. Ou seja, boa parte da corrente elétrica que é passada pelo produto é revertida em iluminação e não em calor.</p>
 
				   <h2>Vida útil longa</h2>
				   <p>Em razão da grande capacidade luminosa que as lâmpadas de LED possuem, podem durar até 25 vezes mais do que as incandescentes e 3 vezes mais do que as fluorescentes. Uma lâmpada de LED usada por 8 horas diárias, por exemplo, pode durar até 17 anos e, ainda assim, sofre pouca alteração no brilho ao longo do tempo.</p>
 
				   <h2>Lâmpada segura</h2>
				   <p>Diferente das fluorescentes, a lâmpada de LED não emite radiação ultravioleta nem causa cansaço visual como os outros tipos, já que não possui mercúrio e nenhuma outra substância tóxica em sua composição, mostrando, assim, que é menos prejudicial à saúde. Por possuir baixa irradiação térmica a lâmpada não esquenta tornando o ambiente muito mais confortável.</p>
				   <p>Sem contar que o funcionamento dessas lâmpadas exige baixa voltagem, o que reduz o risco de choque na hora de trocá-la e permite a instalação em ambientes úmidos como piscinas e cantos de jardim.</p>
 
				   <h2>Design inovador</h2>
				   <p>Além de funcionais e econômicas, as lâmpadas de LED são também decorativas. Nesse tipo de lâmpada é possível controlar o fluxo luminoso (intensidade da luz), variar na tonalidade do branco na iluminação, escolher o tom certo para cada ambiente e, ainda, usá-las nas versões coloridas.</p>
				   <p>Compatíveis com praticamente todos os sistemas de instalação, elas são fáceis substitutas para os tipos mais usados e apresentam uma infinidade de modelos e funcionalidades. A lâmpada de LED apresenta versões compactas, mas com fachos de luz muito eficientes, atribuindo funções específicas a cada modelo.</p>
 
				   <h2>Sustentável</h2>
				   <p>A lâmpada de LED não emite poluentes ao meio ambiente e, ainda, pode ser reciclada. Outra característica importante, é que por gerar economia elétrica também é classificada como um produto sustentável. Como ela não desperdiça calor, diminui o consumo de energia elétrica, reduzindo, assim, os impactos ambientais que são causados.</p>
				   <p>Agora que você já conhece um pouco sobre alguns dos nossos produtos, aproveite a LED Friday e adquira seus produtos com frete expresso grátis e com os melhores valores do mercado nacional!</p>
				   `,
				},
 
				['16490898']: { // pendente led friday
				   html: `
				   <h2>DIVERSOS MODELOS DE PENDENTES NA ILUMINIM! ESCOLHA JÁ O SEU!</h2>
				   <p>Aproveite a LED FRIDAY e encontre seu pendente favorito aqui na iluminim, com o melhor preço do Brasil.</p>
				   <p>Aqui você vai encontrar diversos modelos modernos, que estão em alta em decoração. Garanta o seu e aproveite nossas facilidades: frete grátis em compras acima de R$299,00, desconto de 5% no boleto ou pix, parcelamento em até 12 vezes sem juros, retirada em todo Brasil, garantia de até 5 anos e excelência no material.</p>
 
				   <h2>ACESSÓRIOS LED BLACK FRIDAY</h2>
				   <p>Chegou o mês mais esperado! Aproveite a Black Friday com a maior linha de acessórios do Brasil e frete expresso grátis! Ofertas pensadas para você que quer economizar. Uma super variedade de fonte chaveada, amplificador LED, fios e cabos LED, fonte convencional para fita de LED, sensor de presença, dentre outras opções. Confira, ainda: drivers, emendas para fita, soquetes para lâmpada, chip LED, controladoras e controles RGB, conectores, dimmers, relés fotoelétricos, interruptores e tomadas, e muito mais.</p>
				   <p>Confie na Líder e aproveite a Black Friday. Compre agora mesmo!</p>
				   `,
				},
 
				['881696']: {
				   html: `
					  Em ambiente mais descontraídos, a <a href="/fita-led-rgb">Fita LED RGB</a> pode ser usada para uma iluminação colorida e controlada por controle remoto a até 10 metros de distância. Encontre os modelos <a href="https://www.iluminim.com.br/kit-fitas-led-5050?sort=mais_vendidos">Fita LED RGB 5050</a> e a <a href="https://www.iluminim.com.br/kit-fitas-led-3528?sort=mais_vendidos">LED SMD 3528</a> na Iluminim e não deixe de garantir o seu!
					  <br><br>As fitas têm tamanhos de 5 até 30 metros, são autoadesivas, protegidas por silicone e prontas para uso assim que desembaladas. Você ainda conta com 14 meses de garantia e fabricação dentro dos padrões de regulamentação. Compre online e tenha uma experiência incrível com a Iluminim!
				   `
				},
 
				['881062']: {
				   html: `
					  A nossa loja online de lâmpadas LED possui <strong>Spot de LED</strong> disponível no formato <b><a href="/spot-led-redondo?sort=mais_vendidos">redondo</a></b>, que confere ao ambiente um design mais <i>clean</i>, e também no modelo <b><a href="/spot-led-quadrado?sort=mais_vendidos">quadrado</a></b>, que aumenta o destaque das peças no(s) ambiente(s), os <b>spots</b> são ideais para utilização em sancas de gesso, móveis, banheiros, cozinhas, quartos, escritórios e etc. A maioria dos modelos conta com o <b>foco direcionável</b> que permite uma maior flexibilidade de utilização, tendo em vista que é possível apontar o feixe de luz para o local desejado.
					  <br><br>Os modelos de <strong>spots de LED</strong> disponíveis em nossa loja virtual possuem dois tipos de acabamento: o <b>branco</b>, que confere maior discrição às peças, e também o acabamento em <b>alumínio</b>, que proporciona maior destaque às mesmas.
					  <br><br>Vale lembrar que um dos maiores diferenciais da Iluminim é comercializar produtos prontos para funcionamento. Estes <strong>spots de LED</strong>, em relação aos spots tradicionais, possuem vida útil ampliada, alto índice de economia, índice de reprodução de cor adequado e todas as demais proteções para a saúde que o LED proporciona, como a não emissão de raios ultravioleta e infravermelho. Não perca tempo, desfrute agora mesmo da <b>agilidade, facilidade e custo benefício</b> de ser cliente Iluminim!
				   `
				},
				...
				['2730507']: {
				   html: 'Você está atrás de <strong>Luz Negra LED</strong> de qualidade, mas sem que precise pagar muito caro por isso? Então, aproveite para conferir nossos modelos de <strong>Fita LED Ultravioleta</strong> disponíveis em diversas metragens. Fita de LED UV com colagem adesiva e super luminosidade, perfeita para festas e eventos, além de servir como Fita LED UV para serigrafia.<br><br>Na Iluminim, você pode comprar LED Ultravioleta com condições especiais, as melhores do mercado de iluminação. São até 12x sem juros no cartão ou 5% de desconto no boleto, além do frete totalmente grátis para compras acima de R$ 299,00. A entrega imediata faz parte do pacote de condições imperdíveis para você adquirir o seu LED Luz Negra 12V hoje!<br><br>Confie em quem entende de LED há mais de 10 anos. Confie na líder!'
				},
				...
				['1608472']: {
				   html: 'Se você está aqui, provavelmente está atrás de uma <strong>iluminação para escritório</strong> de alta qualidade, não é?! Então fique tranquilo, pois você está no lugar certo!<br/><br/>A Iluminim oferece a maior linha em <strong>luz de LED para escritório</strong>, seja para a escrivaninha com uma <a href="/luminaria-de-mesa">luminaria de LED para mesa</a>, quanto para o teto com <a href="/spot-led-trilho-eletrificado">spots e trilho eletrificado</a>. Temos tudo em iluminação de alta performance e baixo consumo de energia para o seu ambiente.<br/><br/>De iluminação para escritório pequeno ao grande, garantimos sempre o melhor preço e as melhores condições de pagamento para você. Além disso, temos o prazer de lhe entregar a maior garantia do segmento no Brasil.<br/><br/>Somos a casa da <strong>iluminação de escritório</strong>, compre em até 12x sem juros no cartão, ou receba 5% de desconto para pagamentos no boleto à vista. Entrega rápida e eficaz. Confie em quem entende de LED. Confie na líder!'
				},
				...
				['3152629']: {
				   html: '<strong>Luminaria de teto</strong> led preço? Encontre na Iluminim o menor preço LED disponível. Adquira agora uma Luminaria de teto LED na maior LED Store do Brasil, 8 anos de mercado e líder no segmento. Aproveite o <b>frete expresso grátis</b> para todo o País e o parcelamento em até 12x sem juros. Ainda, se o pagamento for no boleto ganhe 5% de desconto. Não perca que é por tempo limitado!'
				},
				...
				['3152626']: {
				   html: '<strong>Refletor LED Externo</strong> com as melhores condições de pagamento na Iluminim, parcelamento em até <b>12x sem juros ou 5% de desconto</b> para pagamento no boleto bancário. Ainda, ganhe <b>frete expresso grátis</b> em compras acima de R$299,00 para todo o Brasil. Alto desempenho de refletor de led externo aliado a preço baixo. Não perca tempo e adquira o seu, ofertas por tempo limitado!'
				},
	...
	alteracoesTituloPagina(){
	   ...
	   let paginas = {
		  ...
		  ['/lampada-led-tubular']: {
			 ...
			 iniciar(){
				...
				ILUMINIM_UTILS.alterarTituloSairDaPagina('Só hoje: Desconto Tubular');
		  ...
		  ['/lampada-led']: {
			 ...
			 iniciar(){
				...
				ILUMINIM_UTILS.alterarTituloSairDaPagina('Até 12x s/ juros: Lâmpadas LED');
	   ...
	   if(paginas[window.location.pathname]){
 
		  paginas[window.location.pathname].iniciar();
 
	   }
 
	},
 
	bannerListagemCategoria(){
 
	   const bannerListagem = {
		  ...
		  gerarObjeto(){
			 ...
			 let objeto = {
				...
				['/plafon-led-embutir']: {
				   seletor: 'div#listagemProdutos > ul > li.listagem-linha:nth-child(7)',
				   imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/8046504/fd25329999.jpg',
				   link: '/luminaria-plafon-18w-led-embutir-branco-frio-quadrado',
				   nome: 'Luminária Plafon 18w LED Embutir Branco Frio',
				   ativarCronometro: true,
				   texto1: 'SÓ HOJE:',
				   texto2: 'Oferta Imperdível'
				},
 
				['/led-para-area-interna']: {
				   seletor: 'div#listagemProdutos > ul > li.listagem-linha:nth-child(8)',
				   imagem: 'https://cdn.awsli.com.br/300x300/257/257163/produto/29124402/ee1ba1c1f6.jpg',
				   link: '/luminaria-plafon-62x62-48w-led-embutir-branco-neutro-borda-branca',
				   nome: 'Luminária Plafon 62x62 48W LED Embutir Branco Neutro Borda Branca',
				   ativarCronometro: false,
				   texto1: 'MAIS VENDIDOS',
				   texto2: 'LUMINÁRIAS LED'
				},
		  ...
		  gerarHTML(objeto){
			 ...
			 let { imagem, link, nome, ativarCronometro, texto1, texto2 } =  objeto;
 
			 return `
				<div class="banner-listagem">
				   <div class="banner-listagem-conteudo">
			 
					  <div class="banner-listagem-imagem"><img src="${imagem}"></div>
					  
					  <div class="banner-listagem-nome">
						 <span>${nome}</span>
					  </div>
			 
					  <div class="banner-listagem-textos">
						 <div>${texto1}</div>
						 <span>${texto2}</span>
						 ${ ativarCronometro ? `
					  ...
					  ${ ativarCronometro ? `
						 <div class="banner-listagem-conteudo-cronometro">
							<div class="banner-listagem-icone">${ILUMINIM_UTILS.icones.relogio_2}</div>
							<div class="banner-listagem-cronometro">
								  <ul class="countdown-target"></ul>
							</div>
						 </div>
					  ` : `
						 <a class="banner-listagem-link" href="${link}">Confira</a>
					  ` }
		  ...
		  executarCronometro(){
			 ...
			 $('.banner-listagem .countdown-target').yuukCountDown({
				starttime: '2016/11/12 00:00:00',
				endtime: '2030/12/30 00:00:00',
			 });
	   ...
	   bannerListagem.renderizar();
 
	},
 
	duploProdutoSmartFront(){
 
		 let blocks = [
			 '61ba1e402e27306723718b14',
			 '62016b5bed422b37416cabbb',
			 '62138c97ed422b37416d6c09',
			 '6228d1e1035d1a36340414f1',
			 '6229ff9d035d1a363404210f',
			 '622a3135035d1a363404244f',
			 '622bb0ad035d1a3634043615',
			 '6230bc46035d1a3634046487',
			 '6231d821035d1a363404733a',
			 '6231eafb035d1a36340474c4',
			 '62332c32035d1a36340484ed',
			 '623372be035d1a3634048ab3',
			 '6243662b035d1a3634052d65',
			 '61ba1e402e27306723718b14',
			 '626be11bc697f6001679e1ea',
			 '6275633ff092ea0016d451bb',
			 '627907cfea61ec0016b8028b',
			 '6229f613035d1a363404205b',
			 '6286408ef7c1e000162167dd',
			 '62864867f7c1e000162167f1',
			 '6286463bf7c1e000162167e7',
			 '62a39a3a348b2600168905a0'
		 ]
 
		 blocks.forEach(id => {
			 window.SMARTFRONT_CALLBACKS[id] = function(appTarget){
				 appTarget.addClass('duplo-produto-categoria');
			 }
		 });
 
	},
 
	categoriasComTextosAjustados(){
	   ...
	   if(!categorias.includes(window.location.pathname)) return;
 
	   $('body').addClass('categoria-com-textos-ajustados');
 
	   $('#corpo .conteudo > .componente.texto-categoria-rodape').insertAfter('.ordenar-listagem.rodape');
 
	   $('#corpo .conteudo > .componente:first-child').insertAfter('.ordenar-listagem.rodape');
 
 
	   if(ILUMINIM_UTILS.screen.isMobile()){
 
		  $('body').removeClass('categoria-com-textos-ajustados');
 
		  let html = $('#corpo .conteudo > .componente.texto-categoria-rodape .texto-categoria-personalizado').html()
		  $('#corpo .conteudo > .componente:not(.texto-categoria-rodape) .texto-categoria-personalizado').append(html);
		  
		  $('#corpo .conteudo > .componente.texto-categoria-rodape').remove();
	...
	paginasComFundoBlack(){
	 ...
	 programaRetiradaLateral(){
		 
		 $(`<div class="lateral outras filtro-coluna filtro-lista-personalizada programas-retirada">
		 <div class="filtro lista borda-principal">
			 <h4 class="titulo cor-secundaria">Programas  de entrega</h4>
			 <div class="atributo-lista">
				 <ul>
				 <li>
					 <a onclick="ga('send', 'event', 'Confira nossos programas lateral', 'click', 'Termo -> Retirada expressa')" href="/pagina/retirada-expressa.html" title="Retirada expressa" alt="Retirada expressa">
					 <label>Retirada expressa</label>
					 </a>
				 </li>
				 <li>
					 <a onclick="ga('send', 'event', 'Confira nossos programas lateral', 'click', 'Termo -> Entrega no mesmo dia')" href="/pagina/entrega-no-mesmo-dia.html" title="Entrega no mesmo dia" alt="Entrega no mesmo dia">
					 <label>Entrega no mesmo dia</label>
					 </a>
				 </li>
				 <li>
					 <a onclick="ga('send', 'event', 'Confira nossos programas lateral', 'click', 'Termo -> Estacione e retire')" href="/pagina/estacione-e-retire.html" title="Estacione e retire" alt="Estacione e retire">
					 <label>Estacione e retire</label>
					 </a>
				 </li>
				 </ul>
			 </div>
		 </div>
	 </div>`).insertBefore('.lateral.outras.filtro-coluna.filtro-lista-personalizada.palavras-mais-buscadas-lateral');
 
	 },
 
	 tarjaDescontoCupom(){
 
		 let categorias = ['/refletores-de-led', '/ofertadasemana']
	 ...
	 dadosEstruturados(){
		 const dadosEstruturados = {
			 ...
			 JSON(product){
				 let price = product['g:sale_price'] ? product['g:sale_price'] : product['g:price'];
				 let priceFormatted = ILUMINIM_UTILS.formatarPrecoParaPadraoJS(price);
				 ...
				 return {
					 ...
					 "description": product.hasDescription ? product.description : 'Produto Iluminim',
					 "sku": product['g:id'],
					 "offers": {
						 "@type": "Offer",
						 "url": product.link,
			 ...
			 gerarSKUProdutos(){
				 let categoriasComProdutos = {
					 ['/refletores-de-led']: ['RSPM-200WBF-KIT10','RSPM-200WBF-KIT20','RSPM-200WBF','RSPM-100WBF-KIT10','RSPM-100WBF-KIT5','RSPM-200WBF-KIT5','RSPM-200WBF-KIT50','RSPM-100WBF','RSPM-100WBF-KIT20','RSPM-300WBF-KIT10','R-200WBF-KIT20','RSPM-300WBF-KIT20','RSPM-50WBF','RSPM-400WBF-KIT10','R-400WBF-KIT20','RSPM-100WBF-KIT50','RSPM-50WBF-KIT5','RSPM-300WBF-KIT5','R-200WBF-KIT10','RSPM-50WBF-KIT10','RSPM-300WBF','RSPM-400WBF-KIT20','RSPM-500WBF','RSPM-500WBF-KIT10','R-200WBF'],
					 ['/luminarias-led']: ['PS-Q25WBF-KIT20','PG-Q25WBF','PG-Q18WBF-KIT10','PS-Q25WBF','PG-Q25WBF-KIT5','PG-Q25WBF-KIT10','PS-Q25WBF-KIT10','PS-Q48WBF-62X62-KIT20','PG-Q25WBF-KIT20','PS-Q18WBF-KIT20','PG-Q18WBF','PS-Q18WBF-KIT10','PS-Q25WBF-KIT5','PS-Q48WBF-60X60-KIT10','PG-Q18WBF-KIT5','PS-Q18WBF','PG-Q36WBF-40X40','PG-Q18WBF-KIT12','PS-Q48WBF-60X60-KIT20','PG-Q45WBF-60X60','PS-Q48WBF-62X62-KIT10','PS-Q48WBF-62X62-KIT12','PS-Q48WBF-60X60','PG-Q25WBF-KIT12','PS-RT36WBF-15X120'],
					 ['/spots']: ['SMD-Q5WBQ-KIT12','KIT-TL-2-B-6-STP-10WBF','KIT-TL-2-B-6-STP-10WBQ','SMD-Q5WBQ-KIT10','TL1B-3STP-10-BQ','SMD-Q7WBQ','SMD-R7WBF','SMD-Q7WBF','SMD-R5WBF-KIT12','KIT-TL-2-SB-10WBQ','SMD-Q5WBF-KIT12','TL-2-B','SMD-Q5WBF-KIT10','STP-7-BQ','SMD-R5WBQ-KIT20','SMD-Q5WBQ-PACK5','SMD-R7WBF-KIT20','DJ-12WBQ','SMD-R7WBQ-KIT20','STB-24-BN','TL2W-4STB-18-BN','SMD-Q5WBQ-PT','STP-7-BF','TL15W-3STB-18-BN','TL1B-3STP-18-BN'],
					 ['/fita-de-led']: ['XL-5050BQ-KIT5','XL-5050RGB-KIT5','XL-3528BQ-KIT5','XL-5050BQ-KIT10','XL-5050BF-KIT5','XL-5050RGB','XL-5050BQ','XL-5050BF','XL-3528BF-KIT5','XL-5050RGB-KIT10','XL-3528BQ','XL-3528RGB-KIT5','XL-5050BQ-KIT15','XL-3528BQ-KIT100-110V','XL-5050RGB-KIT15','XL-5050BQ-KIT100-220V','XL-5050BQ-KIT30','XL-5050RGB-KIT25','XL-3528BF','XL-3528BQ-KIT100-220V','XL-3528BQ-KIT10','XL-5050BF-KIT10','XL-5050BQ-KIT20','XL-3528RGB-KIT15','XL-3528BF-KIT100-110V'],
					 ['/pendente']: ['PE-LUA-G','LUSTRE-DUQUESA-BR','SL-5949L-H1-CHR','PE-PEROLA-CONSTELACAO-PF','PE-BARI-P-CAR','PE-BARI-P-TAB','RS-01001PT-BELGICA-KIT4','PE-TENESSE-PF','RS-01001PT-BELGICA-KIT2','RS-0610','PE-RT-7W-G','RS-01001CB-BELGICA-KIT2','RS-01001PT-BELGICA','812','GT-01','RS-02001BR-BOLA','CD202022-1','CC-01001','PE-RT-7W-CHR','PE-CORDA-1-E27','4165-DR','PE-RT-7W-RG','PE-BARI-P-PAL','CD2020005-1','CD2020003-1'],
					 ['/lustre']: ['7612-50x50','7615-40x40','SL-5834-H8-CLEAR','SL-93779-C9-CHP','LUSTRE-DUQUESA-BR','RS-0060','RS-0380','RS-0610','SL-5834-H5-CLEAR','812','CD202022-1','SL-93779-C9','7613','LUSTRE-DUQUESA-PT','SL-93128S-C4','RS-0840','RS-0104','SL-93128L-C6','RS-0215','CD2020104','PF-CR-32W-40x40','821','CD2020025','RS-0925','RS-0602'],
					 ['/lampada-led']: ['LT-240BF-KIT20','LT-240BF-KIT50','LT-240BF-KIT10','LT-120BF-KIT50','BULBO-9WBF-PACK6','LT-120BF-KIT20','BULBO-9WBF-R','BULBO-15WBF-PACK3','ALTAPOTENCIA-50WBF','LT-240BF-2','LT-240BF-2-KIT20','LT-240BF','LT-240BF-KIT5','LT-240BF-2-KIT10','LT-240BF-KIT12','LT-120BF','LT-120BF-KIT10','BULBO-15WBF','LT-240BF-2-KIT50','ALTAPOTENCIA-20WBF-KIT10','LT-240BN','LT-60BF-KIT50','PAR30-11WBF','ALTAPOTENCIA-100WBF','PAR20-7WBQ'],
					 ['/arandela-led']: ['ARA-6WBQ-PT-KIT10','ARA-15WBF-KIT10','HM-34973-KIT10','ARA-15WBF-KIT5','ARA-4W-DUO-KIT10','ARA-RISCHI-6WBQ-PT','ARA-15WBF','ARA-RT8WBQ-PT','ARA-10WBQ-KIT10','ARA-CB-6WBQ-PT','ARA-15WBF-KIT2','ARA-12WBF-BR-KIT10','ARA-12WBF-BR','ARA-12WBQ-PT','ARA-4WBQ-BR-KIT5','HM-34973','ARA-5WBQ-SOB','ARA-6WBQ-PT','ARA-10WBF-KIT10','ARA-RT3WBQ-PT-KIT10','ARA-4WBQ-BR','ARA-8WBF-BR','ARA-8WBF-KIT5','ARA-RT3WBQ-PT','ARA-12WBQ-PT-KIT5'],
				 }
				 let produtos = categoriasComProdutos[window.location.pathname];
 
				 if(!produtos){
					 produtos = Array.from($('div#listagemProdutos li.listagem-linha').first().find('.listagem-item')).map(item=> $(item).find('.produto-sku').html());  
				 }
 
				 return produtos;
			 },
		 
			 appendTagScript(JSON){
			 ...
			 renderizar(){
				 ...
				 let validarXML = setInterval(() => {
 
					 if(window.UserStoreXML && window.SMARTFRONT.XML){
						 try {
 
							 let skus = this.gerarSKUProdutos();
							 let result = window.SMARTFRONT.XML.findProdXML(skus) || [];
							 let productsObject = result.map(product => this.JSON(product));
							 let object = {
								 "@context": "https://schema.org/",
								 "@graph": productsObject
							 }
 
							 this.appendTagScript(JSON.stringify(object));
							 clearInterval(validarXML);
		 ...
		 dadosEstruturados.renderizar();
	 },
 
	 iniciar(){ //INICIAR SCRIPTS DA PÁGINA;
 
		 TodasAsPaginas.produtoIndisponivelComSimilar();
		 //TodasAsPaginas.tagCampanhaListagem();
		 ...
		 //this.programaRetiradaLateral();
		 this.pesquisasEmAlta();
		 this.avalicoesTrustVoxCategoria();
		 this.videoCategoria();
		 this.navegacaoCategoria();
		 this.navegacaoCategoriaSimples();
		 this.dropDownTextoCategoria();
		 this.textosRodapeCategoria();
		 this.duploVideo();
		 this.bannerPaginaLampadaBulbo();
		 this.bannerPaginaLEDExterna();
		 this.bannerPaginaLEDParaQuarto();
		 this.alteracoesTituloPagina();
		 this.bannerListagemCategoria();   
		 this.tarjaDescontoCupom();
 
		 //this.paginasComFundoBlack();
 
		 this.categoriasComTextosAjustados(); //MANTER ORDEM
